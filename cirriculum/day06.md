...
What does status = RUNNING tell us?

What does it not tell us?

What additional information would help decide whether the work is abandoned?

What does expiry of ownership mean?

Why does stale ownership not automatically tell us the business outcome?
...
a claimed unit of work must eventually become recoverable if ownership disappears

at most one valid owner may hold permission to perform the protected operation at a time
...
What is the difference between business state and worker ownership?

What does lease expiry prove, and what does it not prove?

Why can sorted input sometimes eliminate the need for a HashMap?

State a two-pointer invariant in your own words.

Why is linked-list indexed access O(n)?

Why can addLast be O(1) if we maintain tail?

What correctness burden does maintaining tail introduce?

Why should index == size fail for get(index)?
...
ownership-vs-business-state distinction

DSA problems actually solved

two-pointer reasoning evidence

Linked List methods actually implemented

tests actually passing

invariant mistakes or boundary bugs discovered

exact pending work

exact Day 7 starting action
